...
$html = file_get_html('http://google.github.io/material-design-icons/');



// Find all images 
foreach($html->find('img') as $element)  {
	$path = "http://google.github.io/material-design-icons";
	$link = $element->src;
	$svgUrl = $path . explode(".", $link)[1] . ".svg";
	$svgArr[] = $svgUrl;
}

//echo '<pre>';print_r(  $svgArr );echo '</pre>';  exit;

echo json_encode($svgArr);
