...
$url = 'http://localhost/pictographr-design/img/fonts/';
$url = 'http://localhost/pictographr-design/img/md-color-svg/';
...
foreach($html->find('img') as $element)  {
	$path = $url;
	$link = $element->src;
	$urlBase = explode(".", $link)[0];
	$base = explode("md-color-svg/", $urlBase)[0];
	$svgUrl = $base.".svg";
	$svgArr = array();
	$svgArr['src'] = 'img/md-color-svg/'. $svgUrl;
//	$svgArr['tags'] = getTags();
	$svgArr['tags'] = '';
	$svgArr['owner'] = 'iconshock';
	$allArr[] = $svgArr;
}

echo '<pre>';print_r(  $allArr );echo '</pre>';  
file_put_contents("icons.json", json_encode($allArr));
