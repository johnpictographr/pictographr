/*
									...
									var pdf = 'pdf_' + app.stubs.google_id + '.pdf',
											url = base_url + 'js/lib/pdf/web/viewer.html?name=../../../../uploads/output/'+ pdf,
											win = window.open(url,	'Pictographr', 'type=fullWindow, fullscreen, scrollbars=yes, modal=yes');
									win.focus();
*/
...
//#if (GENERIC || B2G)
  ...
  var params = PDFViewerApplication.parseQueryString(queryString);
  var file = 'file' in params ? params.file : urlGet('name');
//#endif
//#if (FIREFOX || MOZCENTRAL)
