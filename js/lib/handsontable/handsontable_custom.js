...
var customCallBack;  /* pictographr changes */
...
Handsontable.Core = function (rootElement, userSettings) {
  ...
  var priv
	...
	customCallBack = userSettings.customCallBack;  /* pictographr changes */
...
//        instance.rootElement.addClass(settings.className);
  ...
  this.selectCell = function (row, col, endRow, endCol, scrollToCell) {
  	this.deselectCell();
		...
		if( typeof( customCallBack) == 'function' ) customCallBack( this ); /* pictographr changes */
  	
  	//return;  /* pictographr changes */
...
//  instance.rootElement.addClass('handsontable');
  ...
  this.eventManager.addEventListener(document.documentElement, 'mousedown',function (event) {
  	...
  	if( typeof( customCallBack) == 'function' ) customCallBack(); /* pictographr changes */
