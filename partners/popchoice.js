    ...
    popChoice: function (options) {
      ...
      return this.each(function () {
        ...
        self.popover({
          ...
          content: options.content + '<p class="button-group" style="margin-top: 10px; text-align: center;"><button type="button" class="btn btn-small confirm-dialog-btn-abort">' + options.noBtn + '</button> <button type="button" class="btn btn-small  confirm-dialog-btn-confirm">' + options.yesBtn + '</button></p>'
        }).click(function (e) {
          if (last && last !== self) {
        ...
        var doWhenClose = function( that ) {
					self.parent().parent().removeClass('choosing');
					self.css({
        ...
        self.bind('click', function (e) {
          ...
          $(document).find('.popover .confirm-dialog-btn-confirm').unbind('click').bind('click', function (e) {
            ...
            app.renderFilePngForPost(doItThat, 'png');
            
          });
          
          $(document).find('.popover .confirm-dialog-btn-abort').unbind('click').bind('click', function (e) {
          	
						doWhenClose();
            self.popover('hide').removeClass('popconfirm-active');
            
            app.renderFilePngForPost(doItThat, 'pdf');
