var createGoogleScriptTag = function() {
		...
		client_id = '263278840546-17ag6puh0j6d50d7s3u8i1moco7ei8aj.apps.googleusercontent.com',
		scopes = [
		...
		handleAuthResult = function(authResult) {
		  ...
		  if (authResult && !authResult.error) {  // this user has installed Pictographr on Drive
...
//									console.log(JSON.stringify(  obj   , null, 2 ));
			  ...
			  app.stubs.isGoogleConnected = false;
...
//				console.log(JSON.stringify(  data   , null, 2 ));
				...
				console.log('getfiles from generic extend.js');
...
*/
        ...
        $('.boxes').on('click', function () {
		    ...
		    $('.edit').click(function(e){
		    	...
		    	tools.openInNewTab('https://pictographr.com/app?state=%7B%22ids%22:%5B%22' + fileId + '%22%5D,%22action%22:%22open%22,%22userId%22:%22' + app.stubs.google_id + '%22%7D');
		...
		this.getGoogleIdFromPartner = function( postObj, callback) {
			tools.ajax(	
				'/auth/getGoogleIdFromPartner', 
				postObj,
				'post', 
				function(response) {
					console.log(JSON.stringify( response   , null, 2 ));
