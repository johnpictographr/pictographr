<?php
class Models_Db_Markets_Model extends Database {
  ...
  public function setDatabaseGroup( $db_group ){
	...
	public function getMarketWhere($where_array ){
	...
	public function getAllMarketsWhere($where_array ){
	...
	public function insertMarket( $insert_array ){
	...
	public function updateMarket( $primary_key, $set_what_array ){
