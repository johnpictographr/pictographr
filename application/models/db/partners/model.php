<?php
class Models_Db_Partners_Model extends Database {
  ...
  public function setDatabaseGroup( $db_group ){
	...
	public function getPartnerWhere($where_array ){
	...
	public function insertPartner( $insert_array ){
	...
	public function updatePartner( $primary_key, $set_what_array ){
