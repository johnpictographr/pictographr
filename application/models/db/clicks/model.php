<?php
class Models_Db_Clicks_Model extends Database {
  ...
  public function setDatabaseGroup( $db_group ){
	...
	public function getClickWhere($where_array ){
	...
	public function insertClick( $insert_array ){
	...
	public function updateClick( $primary_key, $set_what_array ){
