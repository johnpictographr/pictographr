<?php
class Models_Db_Visits_Model extends Database {
  ...
  public function setDatabaseGroup( $db_group ){
	...
	public function getVisitWhere($where_array ){
	...
	public function getAllVisitsWhere($where_array ){
	...
	public function insertVisit( $insert_array ){
	...
	public function updateVisit( $primary_key, $set_what_array ){
