<?php class Eventfarm {
	...
	public function __construct() {
		...
		if( isset($_GET['method']) &&  $_GET['method'] == 'dir'){
			$this->seedir();
		}elseif( isset($_GET['method']) && $_GET['method'] == 'uploadang'){
			$this->uploadang();
		}elseif( isset($_GET['method']) && $_GET['method'] == 'upload'){
			$this->upload();
		} else{
			$this->form();
		};
	...
	public function form(){
		...
		?>
			<head>
				<script src="https://pictographr.com/js/lib/jquery/jquery.min.js"></script>
			</head>
			<style>
			...
			<div>
				<div  class="oh">
					...
					<form  id="myform" action="https://pictographr.com/eventfarm.php?method=upload" method="post" enctype="multipart/form-data" target="upload_iframe" >
					    File: <input id="myfile" name="myfile" type="file" />
					          <input type="submit" name="submitBtn" value="Upload" />
					</form>
					<span id="result"></span><img id="loader" src="https://pictographr.com/img/loader.gif" />
				</div>
				<div  class="oh">
					<iframe id="dir_iframe" name="dir_iframe" src="https://pictographr.com/eventfarm.php?method=dir" style="width:100%;height:600;border:1px"></iframe>
				</div>
